...
class NotificationActionReceiver : BroadcastReceiver() {
    ...
    private suspend fun handle(context: Context, intent: Intent) {
        ...
        if (today != null) {
            ...
            val label = com.example.biblicalmonth.util.MonthNames.format(today.monthNumber, namingMode) +
    ...
    companion object {
        ...
        const val ACTION_MOON_SEEN = "com.example.biblicalmonth.action.MOON_SEEN"
        const val ACTION_MOON_NOT_SEEN = "com.example.biblicalmonth.action.MOON_NOT_SEEN"
        const val ACTION_MOON_LATER = "com.example.biblicalmonth.action.MOON_LATER"

        const val ACTION_BARLEY_AVIV = "com.example.biblicalmonth.action.BARLEY_AVIV"
        const val ACTION_BARLEY_NOT_AVIV = "com.example.biblicalmonth.action.BARLEY_NOT_AVIV"
        const val ACTION_BARLEY_LATER = "com.example.biblicalmonth.action.BARLEY_LATER"
    }
}
